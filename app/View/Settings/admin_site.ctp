...
<!--
			...
			<dd>
				<?//=$this->Form->input('site_protocol',array('options'=>array('http://'=>'http://','https://'=>'https://'),'class'=> 'small','label'=>false,'div'=>false,'style'=>'width:80px;'));?>
				<?//=$this->Form->input('site_url',array('class'=> 'small','size'=>'20','label'=>false,'div'=>false,'style'=>'width:160px;'));?>
			</dd>
-->
