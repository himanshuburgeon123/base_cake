<div>
	...
	<fieldset>
		<dl>
			...
			<dd>
				<?=$this->Form->text('mail_to',array('class'=> 'small','size'=>'45','required'=>false)); ?>
			</dd>
			<dt>
				<label>Heading<span style="color:red;">*</span></label>
			</dt>
			<dd>
				<?=$this->Form->text('mail_heading',array('class'=> 'small','size'=>'45','required'=>false)); ?>
			</dd>
            <dt>
            ...
            <dd>
                <?=$this->Form->text('mail_from_name',array('class'=> 'small','size'=>'45','required'=>false)); ?>
            ...
            <dd>
                <?=$this->Form->text('mail_from_email',array('class'=> 'small','size'=>'45','required'=>false)); ?>
