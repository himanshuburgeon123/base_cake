		...
		<fieldset>
			<table width="100%">
				<tr>
					...
					<th width="10%"></th>
					<th width="40%">
					<div style="width:30%;float:left;">View Only</div>
					<div style="width:22%;float:left;">View/Edit</div>	
					<div style="width:30%;float:left;">Full Permission</div>
					</th>
					<th width="5%">&nbsp;</th>
				</tr>
				<tr>
						...
						<table width="100%">
							...
							<?php if($module['name']=='Pages Manager'){
								...
								<td width="60%" align="center">
									<div id="permission<?=$module['file']?>"><?php echo $this->Form->radio('content.'.$module['file'],array('1'=>'','2'=>'','3'=>''),array('label'=>false,'legend'=>false,$disabled,'style'=>'margin-left:50px;margin-right:45px;'));?></div>
								</td>					
							</tr>
